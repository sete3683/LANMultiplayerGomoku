...
namespace Core
{
    public abstract class Session
    {
        ...
        RecvBuffer _recvBuffer = new RecvBuffer(512);
        protected SendBuffer _sendBuffer = new SendBuffer(512);
        ...
        public SendBuffer SendBuffer { get { return _sendBuffer; } }

        public abstract void MyConnectMethod(EndPoint ep);
        public abstract void MySendMethod();
        ...
        int CheckPacket(ArraySegment<byte> segment)
        {
            ...
            while (true)
            {
                ...
                MyRecvMethod(new ArraySegment<byte>(segment.Array, segment.Offset, packetSize));

                recvCount += packetSize;
                segment = new ArraySegment<byte>(segment.Array, segment.Offset + packetSize, segment.Count - packetSize);
            }
